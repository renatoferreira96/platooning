...
{
    this->abortFlag = other.abortFlag;
}

void Abort::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::ManeuverMessage::parsimPack(b);
    doParsimPacking(b,this->abortFlag);
}

void Abort::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::ManeuverMessage::parsimUnpack(b);
    doParsimUnpacking(b,this->abortFlag);
}

bool Abort::getAbortFlag() const
{
    return this->abortFlag;
}

void Abort::setAbortFlag(bool abortFlag)
{
...
int AbortDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='a' && strcmp(fieldName, "abortFlag")==0) return base+0;
...
std::string AbortDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Abort *pp = (Abort *)object; (void)pp;
    switch (field) {
        case 0: return bool2string(pp->getAbortFlag());
        default: return "";
    }
}
...
bool AbortDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Abort *pp = (Abort *)object; (void)pp;
    switch (field) {
        case 0: pp->setAbortFlag(string2bool(value)); return true;
