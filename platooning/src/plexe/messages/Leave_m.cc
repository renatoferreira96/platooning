...
Leave::Leave(const char *name, short kind) : ::ManeuverMessage(name,kind)
{
    this->platoonSpeed = 0;
    this->platoonLane = 0;
    newPlatoonFormation_arraysize = 0;
    this->newPlatoonFormation = 0;
    this->platoonLeaderId = 0;
}

Leave::Leave(const Leave& other) : ::ManeuverMessage(other)
{
    newPlatoonFormation_arraysize = 0;
    this->newPlatoonFormation = 0;
    copy(other);
...
void Leave::copy(const Leave& other)
{
    ...
    this->platoonLeaderId = other.platoonLeaderId;
}
...
void Leave::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->platoonLeaderId);
}
...
void Leave::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->platoonLeaderId);
}

double Leave::getPlatoonSpeed() const
{
    return this->platoonSpeed;
}

void Leave::setPlatoonSpeed(double platoonSpeed)
{
    this->platoonSpeed = platoonSpeed;
}

int Leave::getPlatoonLane() const
{
    return this->platoonLane;
}

void Leave::setPlatoonLane(int platoonLane)
{
    this->platoonLane = platoonLane;
}

void Leave::setNewPlatoonFormationArraySize(unsigned int size)
{
...
unsigned int Leave::getNewPlatoonFormationArraySize() const
{
    return newPlatoonFormation_arraysize;
}

int Leave::getNewPlatoonFormation(unsigned int k) const
{
...
void Leave::setNewPlatoonFormation(unsigned int k, int newPlatoonFormation)
{
    if (k>=newPlatoonFormation_arraysize) throw omnetpp::cRuntimeError("Array of size %d indexed by %d", newPlatoonFormation_arraysize, k);
    this->newPlatoonFormation[k] = newPlatoonFormation;
}

int Leave::getPlatoonLeaderId() const
{
    return this->platoonLeaderId;
}

void Leave::setPlatoonLeaderId(int platoonLeaderId)
{
    this->platoonLeaderId = platoonLeaderId;
}
...
LeaveDescriptor::LeaveDescriptor() : omnetpp::cClassDescriptor("Leave", "ManeuverMessage")
{
...
int LeaveDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='p' && strcmp(fieldName, "platoonLeaderId")==0) return base+3;
...
std::string LeaveDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return long2string(pp->getPlatoonLeaderId());
        default: return "";
    }
}
...
bool LeaveDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 3: pp->setPlatoonLeaderId(string2long(value)); return true;
