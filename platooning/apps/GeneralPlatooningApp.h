...
enum class PlatoonRole : size_t {
    ...
    AVAILABLE ///< The vehicle is available to be new leader
};
...
public:
    ...
    /**
     * Request start of LeaveManeuver to leader
     * @param int platoonId the id of the platoon to join
     * @param int leaderId the id of the leader of the platoon to join
     */
    void startLeaveManeuver(int platoonId, int leaderId);

    /** Abort join maneuver */
    void abortJoinManeuver();

    /** Abort leave maneuver */
    void abortLeaveManeuver();
...
private:
    ...
    /**leave maneuver implementation */
    LeaveManeuver* leaveManeuver;
};
